...
public class MealTestData {
    ...
    public static void assertMatchTo(Iterable<MealTo> actual, Meal... expected) {
        List<MealTo> exp = MealsUtil.getWithExcess(List.of(expected), SecurityUtil.authUserCaloriesPerDay());
        assertThat(actual).usingElementComparatorIgnoringFields("user").isEqualTo(expected);
    }

    public static ResultMatcher contentJson(Meal... expected) {
        List<MealTo> mt = MealsUtil.getWithExcess(Arrays.asList(expected),SecurityUtil.authUserCaloriesPerDay());
        return result -> assertMatchTo(readListFromJsonMvcResult(result, MealTo.class), mt);
    }
    public static ResultMatcher contentJson(Meal expected) {
